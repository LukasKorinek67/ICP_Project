...
// Nastavení callbacků pro klávesy
...
// Funkce bere komplexní informace o OpenGL debug zprávě a převádí je na lidsky čitelný formát, který je následně vypsán do konzole
// Umožňuje snadno sledovat a diagnostikovat problémy v aplikaci
